...
class UsersHeader extends StatelessWidget {
  const UsersHeader({this.searchController, this.onSearchChanged, super.key});
...
class _HeaderText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Users', style: AppTextStyles.headingLarge),
        SizedBox(height: 8.h),
        Text(
          'Manage users, bookings, payments and activity.',
...
class _SearchUserField extends StatelessWidget {
  const _SearchUserField({this.controller, this.onChanged});
